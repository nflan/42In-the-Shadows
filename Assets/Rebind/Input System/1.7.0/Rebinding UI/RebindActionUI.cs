    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        private void PerformInteractiveRebind(InputAction action, int bindingIndex, bool allCompositeParts = false)
        {
            ...
            m_RebindOperation = action.PerformInteractiveRebinding(bindingIndex)
                .WithControlsExcluding("<Mouse>/leftButton") // Exclude left button as new binding.
                .WithControlsExcluding("<Mouse>/rightButton") // Exclude right button as new binding.
                .WithControlsExcluding("<Mouse>/press") // Exclude any pressed button as new binding.
